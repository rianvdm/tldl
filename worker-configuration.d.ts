/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4649c4adca976871b84c39af8a9ab805)
// Runtime types generated with workerd@1.20260205.0 2024-01-01 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "JobStatusDO";
	}
	interface Env {
		...
		TURNSTILE_SITE_KEY: "0x4AAAAAACI8nqr-nsEAR6gr";
		POSTMARK_FROM_EMAIL: "rian@elezea.com";
		...
		CLOUDFLARE_ZONE_EDIT_TOKEN: string;
		MANAGE_LINK_HMAC_SECRET: string;
		POSTMARK_WEBHOOK_AUTH: string;
		JOB_STATUS: DurableObjectNamespace<import("./src/index").JobStatusDO>;
	}
}
